...
Route::get('/auth/qq', ['uses' => 'Auth\AuthController@redirectToQq', 'as' => 'qq.login']);
Route::get('/auth/qq/callback', ['uses' => 'Auth\AuthController@handleQqCallback', 'as' => 'qq.callback']);
Route::get('/qq/register', ['uses' => 'Auth\AuthController@registerFromQq', 'as' => 'qq.register']);
Route::post('/qq/store', ['uses' => 'Auth\AuthController@store', 'as' => 'qq.store']);
